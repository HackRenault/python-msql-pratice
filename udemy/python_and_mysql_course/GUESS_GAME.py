...
# # initialize list comprehension, and use split to remove the space
# list_of_numbers = [int(nos) for nos in no_list.split()]
# total_num = sum(list_of_numbers)
# print(total_num)
# print()

def list_compare(list1, list2):
    # we go create one empty list called common_elements wey we go store the common items
    compared_list = []
    # we go come use one loop go through all the item for list1, then check if the item dey list2
    for item in list1:
        if item in list2:
...
print("This script takes two list from the user and prints out the common item")
first_list=[]
second_list=[]
while True:
    new_first_list = input("Enter first-list items. (Enter 'done' to complete): ")
    if new_first_list.lower() == "done":
        break
    first_list.append(new_first_list)
    
while True:
    new_second_list = input("Enter second-list items. (Enter 'done' to complete): ")
    if new_second_list.lower() == "done":
        break
    second_list.append(new_second_list)
    
print("The items in your first list are: ", first_list)
print("The items in your second list are: ", second_list)
print("The common items in both list is: ", list_compare(first_list,second_list))
